...
private[scheduler]
case class PauseEvent(task: Task[_], taskInfo: TaskInfo) extends DAGSchedulerEvent

private[scheduler]
case class ResumeEvent(task: Task[_], taskInfo: TaskInfo) extends DAGSchedulerEvent
