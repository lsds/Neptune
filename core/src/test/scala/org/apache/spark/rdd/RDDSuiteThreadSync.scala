...
class RDDSuiteThreadSync extends SparkFunSuite {
  var tempDir: File = _
  ...
  override def beforeAll(): Unit = {
    ...
    conf = new SparkConf().setMaster("local").setAppName("RDD ThreadSync suite test")
  ...
  test("Neptune ThreadSync basic operations") {
 ...
 test("coalesced RDDs with partial locality") {
  ...
  test("take") {
    ...
    // TODO: support async in a future Neptune release
