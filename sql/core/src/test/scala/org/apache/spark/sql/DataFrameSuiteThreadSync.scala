...
import org.apache.spark.sql.test.{ExamplePoint, ExamplePointUDT, SharedThreadSyncSQLContext}
...
class DataFrameSuiteThreadSync extends QueryTest with SharedThreadSyncSQLContext {
...
//  TODO: Neptune known issue based on FileFormatWriter with parquet format
